...
public class ExperimentDAO {
    ...
    protected static final String insertQuery = "INSERT INTO " + table + " (Name, Date, description, numRuns, timeOut, memOut, maxSeed, autoGeneratedSeeds) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    protected static final String updateQuery = "UPDATE "+table+" SET Name =?, Date =?, description =?, numRuns =?, timeOut =?, memOut =?, maxSeed =?, autoGeneratedSeeds =? WHERE idExperiment=?";
