...
public class ExperimentDAO {
    ...
    protected static final String insertQuery = "INSERT INTO " + table + " (Name, Date, description, maxSeed, autoGeneratedSeeds, linkSeeds, configurationExp, priority, active) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    protected static final String updateQuery = "UPDATE " + table + " SET Name =?, Date =?, description =?, maxSeed =?, autoGeneratedSeeds =?, linkSeeds =?, configurationExp =?, priority =?, active=? WHERE idExperiment=?";
    ...
    public static void save(Experiment experiment) throws SQLException {
        ...
        st.setBoolean(7, experiment.isConfigurationExp());
        st.setInt(8, experiment.getPriority());
        st.setBoolean(9, experiment.isActive());
        st.executeUpdate();
