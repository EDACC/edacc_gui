 ...
 * @author rretz
 */
public class EDACCRecursiveFileScanner {
	 ...
	 */
	public EDACCRecursiveFileScanner(String fileExtension){
	 ...
	 */
	public LinkedList<File> searchFileExtension(File root)throws IOException, FileNotFoundException{
